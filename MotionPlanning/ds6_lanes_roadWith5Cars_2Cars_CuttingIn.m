function [scenario, egoVehicle, egoWaypoints, allrefPaths, allStatus, roadConfigs] = ds6_lanes_roadWith5Cars_2Cars_CuttingIn()
...
allStatus = cell(0);
roadConfigs = cell(0);
egoWaypoints = [-56.4081537864988 -5.96299137340629 0;
    -4.8 -5.7 0;
    21.5 -5.6 0;
    52.4 -5.8 0;
    74.8 -5.6 0;
